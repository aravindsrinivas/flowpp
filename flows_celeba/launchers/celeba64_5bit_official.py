"""
Num params: 73489960
Run it as: mpiexec -n {num_processes} python3.6 -m flows_celeba.launchers.celeba64_5bit_official from the flows master directory of the git repo. 
...
def main():
    ...
    flow_training_celeba.train(
        ...
        logdir=f'~/logs/2018-11-12/celeba64_5bit_ELU_code_release_mix{components}_b{blocks}_f{filters}_h{attn_heads}_ln{int(use_ln)}_lr{max_lr}_bs{bs}_drop{dropout_p}_{floatx_str}',
